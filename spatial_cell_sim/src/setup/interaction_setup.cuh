...
linkParticlesSerially(
	...
	for (int i = start + 1; i < end; i++) {
		...
		interactionPartner->interactions[interactionPartner->nActiveInteractions].group = interactionGroup;
		...
		p->interactions[p->nActiveInteractions].group = interactionGroup;
